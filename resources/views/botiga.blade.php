  ...
  @include('includes.nav')
    ...
    <section class="flex flex-col justify-center items-center mt-[48px] mb-12">
        ...
        <div class="-mt-28 lg:w-[960px] px-5 lg:px-0 flex flex-col lg:flex-row items-center">
            ...
            <img src="{{asset($botiga->Logo)}}" class="w-48 bg-white rounded-full lg:mr-10 border-8 border-zinc-200" alt="Logo {{$botiga->NomBotiga}}">
    ...
    <section class="flex justify-center items-center">
        ...
        <div class="lg:w-[960px] flex flex-col lg:flex-row justify-between items-start">
                    ...
                    <div class="w-full lg:w-1/2 flex justify-start items-center p-6 bg-white lg:rounded-md lg:mx-3 mb-10 lg:mb-0 lg:drop-shadow-lg">
                        ...
                        <div>
                            ...
                            @if($botiga->propietari->name == 'Yandrax')
                                <p class="font-MinecraftRegular text-zinc-500 text-base">Degà del Col·legi</p>    
                            @else
            ...
            <div class="lg:w-1/2 bg-white lg:mx-3 p-5 font-MinecraftRegular text-sm text-zinc-600 lg:rounded-md lg:drop-shadow-lg">
                <p>Ubicada a {{$botiga->Municipi}}. Coordenades: X: {{$coordenades[2]}}, Y: {{$coordenades[4]}}</p>
    ...
    @if($botiga->NomBotiga == 'Xip-xap Blog')                    
    <div class="mx-5 lg:mx-52 flex hover:cursor-pointer justiy-center items-center" onclick="alert('Pastisset trobat: 74543')">
        <img src="{{asset('/pastissets/NabiusNaturals.png')}}" class="w-10 mr-3" alt="Pastisset Nabius Naturals">
        <p class="font-MinecraftBold text-sky-600">Nabius Naturals</p>
    </div>
    @endif
        ...
        <section class="flex justify-center items-center mt-20">
            ...
            <div class="lg:w-[960px] grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-3 mx-5 lg:mx-0">
                    @if($botiga->propietari->name == 'Yandrax')
                        <h2 class="text-4xl text-black font-MinecraftBold">Recursos</h2>
                    @else
