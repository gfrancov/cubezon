...
<body class="bg-zinc-200">
  @include('includes.nav')
    ...
    <section class="flex flex-col justify-center items-center mt-[48px] mb-12">
        <div class="lg:w-[960px] px-5 lg:px-0 flex flex-col lg:flex-row items-center">
            
            <div class="mt-10 lg:mt-32">
                <div class="flex">
                    <h1 class="font-MinecraftBold text-4xl lg:text-6xl mr-2">{{$categoria->NomCategoria}}</h1>
                </div>
                <p class="font-MinecraftRegular text-zinc-500 text-lg">{{$categoria->Descripcio}}</p>
            </div>
        ...
        <section class="flex justify-center items-center mt-20">
            ...
            <div class="lg:w-[960px] grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-3 mx-5 lg:mx-0">
                        <h2 class="text-4xl text-black font-MinecraftBold">Productes de la categoria</h2>
                </div>
