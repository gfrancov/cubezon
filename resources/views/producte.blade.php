...
@include('includes.nav')
    ...
    <section class="mt-[48px] py-24 flex justify-center items-center">
        ...
        <div class="lg:w-[960px] flex flex-col lg:flex-row justify-center items-start mx-5 lg:mx-0">
            ...
            <div class="lg:w-1/2 flex flex-col justify-start items-center mb-6 lg:mb-0">
            ...
            <div class="lg:w-1/2 flex flex-col justify-start items-start p-8 bg-white lg:rounded-md lg:shadow-lg">
                <div class="flex">
                    ...
                    <span class="text-sm flex justify-center items-center text-white px-2 py-1 bg-red-700 rounded-sm font-MinecraftBold">OFERTA</span>
                    @endif
                </div>
                ...
                <div class="mt-6">
                    ...
                    <?php 
                        ...
                        $coordenades = explode(":",$producte->botiga->Mapa);

                    ?>

                    <div class="">
                        <p class="font-MinecraftRegular text-zinc-500 text-sm">Aquesta botiga es troba a {{$producte->botiga->Municipi}}. Coordenades X: {{$coordenades[2]}}, Y: {{$coordenades[4]}}</p>
