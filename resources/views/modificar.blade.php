        ...
        <div class="w-[680px] mx-auto p-8 bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <form action="{{ route('productes.store') }}" method="POST">
                ...
                <div class="form-group flex flex-col mb-3">
                    ...
                    <input type="number" class="form-control" id="Preu" name="Preu" value="{{$producte->Preu}}" required>
                </div>
                <div class="form-group flex flex-col mb-3">
                    <label for="Estoc">Estoc</label>
                    <input type="number" class="form-control" id="Estoc" name="Estoc" value="{{$producte->Estoc}}" required>
                </div>
                <button type="submit" class="p-2 py-1 mt-2 bg-green-800 hover:bg-green-600 text-white rounded-sm btn btn-primary">Guardar cambios</button>
            </form>
